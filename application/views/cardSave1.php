        ...
        <div class="widget-content nopadding">
           <?php echo form_open_multipart('Saving/bankDetails', ['class'=>'navbar-form navbar-right']);?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Bank Name" name="bank_name" />
              </div>
              <?php echo form_error('bank_name', '<div class="error">', '</div>'); ?>
               <div class="control-group">
              <label class="control-label">Account Name:</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Card Number" name="account_name" />
              </div>
              <?php echo form_error('account_name', '<div class="error">', '</div>'); ?>
              <div class="control-group">
             <label class="control-label">Account Number:</label>
             <div class="controls">
               <input type="number" class="span11" placeholder="Card Number" name="account_number"/>
             </div>
             <?php echo form_error('account_name', '<div class="error">', '</div>'); ?>
               <div class="control-group">
              <label class="control-label">BVN:</label>
              <div class="controls">
                <input type="number" class="span11" placeholder="Card Number " name="bvn" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span11" placeholder="Card Number" / name="card_number">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="datepicker" class="span11" placeholder="MM/YY" / name="expiration_date">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number"  class="span11" placeholder="CVV"  / name="cvv">
              </div>
            </div>
