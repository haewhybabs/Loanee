		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                <div class="card wizard-card" data-color="green" id="wizardProfile">
		                   <?php echo form_open_multipart('Admin_dashboard/MonthlyPaymentC', ['role'=>'form']);?>
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
                    <?php foreach ($monthlypayment as $key):?>
								...
								<div class="wizard-navigation">
									<ul>
			                            ...
			                            <li><a href="#address" data-toggle="tab">Loan Percentage</a></li>
		                            ...
		                            <div class="tab-pane" id="address">
		                                <div class="row">
		                                    <div class="col-sm-12">
		                                        <h4 class="info-text"> x% </h4>
		                                    </div>
		                                    <div class="col-sm-7 col-sm-offset-1">
	                                        	<div class="form-group label-floating">
	                                        		<label class="control-label">Monthly payment Percentage</label>
	                                    	   		<input type="number" class="form-control" name="savepercentage" value="<?=$key->savepercentage;?>">
                                                <?php echo form_error('savepercentage', '<div class="error">', '</div>'); ?>
	                                        	</div>
                                        ...
                                        <div class="col-sm-7 col-sm-offset-1">
                                           <div class="form-group label-floating">
                                             <label class="control-label">Loan Payment Percentage</label>
                                             <input type="number" class="form-control" name="loanpercentage" value="<?=$key->loanpercentage;?>">
                                           </div>
                                           <?php echo form_error('loanpercentage', '<div class="error">', '</div>'); ?>
		                            ...
		                            <div class="pull-right">
		                                ...
		                                <input type='submit' class='btn btn-finish btn-fill btn-success btn-wd' name='submit' value='Enter' />
		                            </div>
