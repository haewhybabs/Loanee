		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
	             ...
	             <?php echo form_open_multipart('Admin_dashboard/AddUsers', ['class'=>'login100-form validate-form']);?>
					...
					<div class="wrap-input100 validate-input" data-validate = "please input your first name">
						<input class="input100" type="text" name="first_name" placeholder="Admin First Name" value="<?= set_value('first_name');?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "please input your last name"  value="<?= set_value('last_name');?>">
						<input class="input100" type="text" name="last_name" placeholder="Admin Last Name">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "please input your username"  value="<?= set_value('username');?>">
						<input class="input100" type="text" name="username" placeholder="Create Admin Username">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "mobile">
						<input class="input100" type="phone" name="mobile" placeholder="Enter Admin phone number"  value="<?= set_value('mobile');?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="passwordconf" placeholder="Confirm Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
