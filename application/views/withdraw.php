		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                <div class="card wizard-card" data-color="green" id="wizardProfile">
		                   <?php echo form_open_multipart('Saving/withdraw_cash', ['role'=>'form']);?>
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
		                    	...
		                    	<div class="wizard-header">
									...
									<h5>Enter any Amount, then Click save, to effect your transaction </h5>
		                    	</div>
								<div class="wizard-navigation">
									<ul>

			                            <li><a href="#address" data-toggle="tab">Withdraw your Investment</a></li>
		                                ...
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-7 col-sm-offset-1">
	                                        	<div class="form-group label-floating">
	                                        		<label class="control-label">Enter Amount to withdraw in Naira </label>
		                            ...
		                            <div class="pull-right">
		                                ...
		                                <input type='submit' class='btn btn-finish btn-fill btn-success btn-wd' name='finish' value='Withdraw' />
		                            </div>
