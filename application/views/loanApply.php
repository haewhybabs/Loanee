		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                <div class="card wizard-card" data-color="green" id="wizardProfile">
		                   <?php echo form_open_multipart('registration/login');?>
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->


		                <div class="wizard-header">
		                        	<h3 class="wizard-title">
		                        		Please fill in all the fields for a successful application
		                        	</h3>
									<h5>This information will let us know more about you.</h5>
		                    	</div>
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#details" data-toggle="tab">Request Loan</a></li>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="details">
		                            	<div class="row">
			                            	<div class="col-sm-12">
			                                	<h4 class="info-text"> You will be done in no time</h4>
			                            	</div>
		                                	<div class="col-sm-6">
												<div class="input-group">
													...
													<div class="form-group label-floating">
			                                          	...
			                                          	<input name="accountnumber" type="number" class="form-control">
			                                        </div>
												</div>
												...
												<div class="input-group">
													...
													<div class="form-group label-floating">
			                                          	<label class="control-label">Input BVN(Your BVN is secure with us)</label>
											...
											<div class="input-group">
												 ...
												 <p>Upload Valid I.D/Certificate of Incorporation
		                                	...
		                                	<div class="col-sm-6">
												...
												<div class="form-group label-floating">
													...
													<div class="form-group label-floating">
			                                          	<label class="control-label">How Much do you Need? (Naira)</label>
		                                    	...
		                                    	<div class="input-group">
												 ...
												 <p>Upload other essential documents
											        <a href="#" class="btn btn-success btn-sm">
											          <span class="glyphicon glyphicon-upload"></span> Upload
											        </a>
											      </p>
...
<form action="" method=""> -->
		                <!--        You can switch " datfile:///C:/Users/USER/Desktop/Refined%20U.I/loanApply.html?finish=Save#a-color="blue" "  with one of the next bright colors: "green", "orange", "red", "purple"             -->
