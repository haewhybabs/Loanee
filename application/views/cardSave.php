...
<link rel="stylesheet" href="<?=base_url('assets/css1/colorpicker.css');?>" />
<link rel="stylesheet" href="<?=base_url('assets/css1/datepicker.css');?>" />
<link rel="stylesheet" href="<?=base_url('assets/css1/uniform.css');?>" />
<link rel="stylesheet" href="<?=base_url('assets/css1/select2.css');?>" />
...
<link rel="stylesheet" href="<?=base_url('assets/css1/bootstrap-wysihtml5.css');?>" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="#">Refined Finance</a></h1>
</div>
<!--close-Header-part-->
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Bank Details</a> <a href="#" class="current">Bank Details</a> </div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
           <?php echo form_open_multipart('Saving/bankDetails', ['class'=>'navbar-form navbar-right']);?>
            ...
            <?php foreach ($fetch_bank as $get):?>


            <div class="control-group">
              <label class="control-label">Bank Name:</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Bank Name" name="bank_name" value="<?=$get->bank_name;?>" />
              </div>
              <?php echo form_error('bank_name', '<div class="error">', '</div>'); ?>
               <div class="control-group">
              <label class="control-label">Account Name:</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Account Name" name="account_name" value="<?=$get->account_name ;?>"/>
              </div>
             ...
             <div class="controls">
               <input type="number" class="span11" placeholder="Account Number" name="account_number" value="<?=$get->account_number ;?>"/>
             </div>
             <?php echo form_error('account_name', '<div class="error">', '</div>'); ?>
               <div class="control-group">
              <label class="control-label">BVN:</label>
              <input type="number" class="span11" placeholder="BVN " name="bvn" value="<?=$get->bvn ;?>"/>
              <div class="controls">
              </div>
            </div>
            <?php echo form_error('bvn', '<div class="error">', '</div>'); ?>
            <div class="control-group">
              <label class="control-label">Card Number :</label>
              <div class="controls">
                <input type="number" class="span11" placeholder="Card Number" name="card_number" value="<?=$get->card_number ;?>"/>
              </div>
            </div>
            <?php echo form_error('card_number', '<div class="error">', '</div>'); ?>
            <div class="control-group">
              <label class="control-label">Expiration Date :</label>
              <div class="controls">
                <input type="datepicker" class="span11" placeholder="MM/YY" name="expiration_date" value="<?=$get->expiration_date ;?>"/>
              </div>
            </div>
            <?php echo form_error('expiration_date', '<div class="error">', '</div>'); ?>
            <div class="control-group">
              <label class="control-label">CVV/CVC</label>
              <div class="controls">
                <input type="number"  class="span11" placeholder="CVV"  name="cvv" value="<?=$get->cvv ;?>"/>
              </div>
            </div>
            <?php echo form_error('cvv', '<div class="error">', '</div>'); ?>
            <div class="control-group">
              <label class="control-label">Id card</label>
              <div class="controls">
                <input type="file" name="userfile" value="upload your id card"/>
              </div>
            </div>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> 2018 &copy; Refined Finance <a href="#"> </a> </div>
</div>
<!--end-Footer-part-->
...
<script src="<?=base_url('assets/js1/bootstrap-colorpicker.js');?>"></script>
<script src="<?=base_url('assets/js1/bootstrap-datepicker.js');?>"></script>
<script src="<?=base_url('assets/js1/jquery.toggle.buttons.js');?>"></script>
<script src="<?=base_url('assets/js1/masked.js');?>"></script>
...
<script src="<?=base_url('assets/js1/matrix.form_common.js');?>"></script>
<script src="<?=base_url('assets/js1/wysihtml5-0.3.0.js');?>"></script>
<script src="<?=base_url('assets/js1/jquery.peity.min.js');?>"></script>
<script src="<?=base_url('assets/js1/bootstrap-wysihtml5.js');?>"></script>
<script>
