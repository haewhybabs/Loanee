...
<div id="sidebar"><a href="<?=base_url('Dashboard');?>" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="<?=base_url('Admin_dashboard');?>"><i class="icon icon-home"></i> <span>Admin Dashboard</span></a> </li>
    <li> <a href="<?=base_url('Admin_dashboard/getUsers');?>"><i class="icon icon-signal"></i> <span>All Users</span></a> </li>
    <li> <a href="<?=base_url('Admin_dashboard/getLoanUser');?>"><i class="icon icon-inbox"></i> <span>Loan Transactions</span></a> </li>
    <li><a href="<?=base_url('Admin_dashboard/savingsWithdrawal');?>"><i class="icon icon-fullscreen"></i> <span>Investment and Savings</span></a></li>
      <li><a href="<?=base_url('Admin_dashboard/MonthlyPayment');?>"><i class="icon icon-fullscreen"></i> <span>Investment Monthly Payment</span></a></li>


    <li><a href="<?= base_url('Dashboard/settings_view');?>"><i class="icon icon-tint"></i> <span>Settings</span></a></li>
    <li><a href="<?=base_url('Admin_dashboard/add_users');?>"><i class="icon icon-tint"></i> <span>Add Users</span></a></li>
    <li><a href="<?=base_url('Admin_dashboard/logout');?>"><i class="icon icon-pencil"></i> <span>Logout</span></a></li>
