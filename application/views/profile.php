		            ...
		            <div class="wizard-container">
		                ...
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <?php foreach ($get_profile_user as $get_profile):?>
		                                ...
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-7 col-sm-offset-1">
	                                        	<div class="form-group label-floating">
	                                    			...
	                                    			<input type="text" class="form-control" name="house_number" value="<?=$get_profile->house_number;?>">
	                                        	</div>
		                                    </div>
		                                    <div class="col-sm-3">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label">Street Name</label>
		                                            <input type="text" class="form-control" name="street_name" value="<?= $get_profile->street_name;?>">
		                                        </div>
		                                    </div>
		                                    <div class="col-sm-5 col-sm-offset-1">
		                                        <div class="form-group label-floating">
		                                            <label class="control-label">City</label>
		                                            <input type="text" class="form-control" name="city" value="<?= $get_profile->city;?>">
		                                        </div>
		                                    </div>
		                                    <div class="col-sm-5">
		                                        <div class="form-group label-floating">
