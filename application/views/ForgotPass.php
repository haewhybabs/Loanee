		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                <div class="card wizard-card" data-color="green" id="wizardProfile">
		                   <?php echo form_open_multipart('Index/ForgotPass', ['role'=>'form']);?>
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
		                    	...
		                    	<div class="wizard-header">
									...
									<h5>Recover Your Password With Your Registered Email </h5>
		                    	</div>
								<div class="wizard-navigation">
									<ul>

			                            <li><a href="#address" data-toggle="tab">Just Your Email</a></li>
		                            ...
		                            <div class="tab-pane" id="address">
		                                <div class="row">
		                                    <div class="col-sm-12">
		                                        <h4 class="info-text">Forgot Your Password </h4>
		                                    </div>
